...
#define WINDOW_BACKGROUND_COLOR ( al_map_rgba_f( 0.3, 0.3, 0.3, 1 ) )
#define WINDOW_BORDER_COLOR ( al_map_rgba_f( 1, 1, 1, 1 ) )
...
#define BACKGROUND_COLOR NULL_COLOR
#define PANEL_BORDER_COLOR NULL_COLOR
#define PANEL_BACKGROUND_COLOR DARK_GREY_COLOR
#define PANEL_COLUMN_BACKGROUND_COLOR DARK_GREY_COLOR
#define PANEL_COLUMN_BORDER_COLOR GREY_COLOR
#define CLUE_TILE_BACKGROUND_COLOR NULL_COLOR
#define CLUE_TILE_BORDER_COLOR NULL_COLOR
#define PANEL_TILE_BORDER_COLOR NULL_COLOR
#define CLUE_PANEL_BACKGROUND_COLOR DARK_GREY_COLOR
#define CLUE_PANEL_BORDER_COLOR GREY_COLOR
#define INFO_PANEL_BACKGROUND_COLOR DARK_GREY_COLOR
#define INFO_PANEL_BORDER_COLOR GREY_COLOR
#define TIME_PANEL_BACKGROUND_COLOR DARK_GREY_COLOR
#define TIME_PANEL_BORDER_COLOR GREY_COLOR

#define GUI_BACKGROUND_COLOR al_map_rgb( 100, 100, 100 )
